const quiz =[
  {
  question:'問:A立先生には、年下の奥様がいらっしゃいます。さて、A立先生と奥様は年齢がいくつ離れているでしょうか？',
  answers: ['5歳差','8歳差','12歳差','15歳差'],
  correct:'15歳差',
  studies:'<span>A.15歳差。</span>A立先生には2歳の男の子と0歳の女の子、<br>2人のお子様がいらっしゃいます。女の子の方の<br>夜泣きが凄まじく、大変だそうです。'
  },{
  question:'問: A立先生は、中学校、高校と続けて同じ部活動に取り組んでいました。さて、その部活動とは次のうちどれでしょう？',
  answers:['サッカー部','陸上部','卓球部','野球部'],
  correct:'陸上部',
  studies:'<span>A.陸上部。</span>A立先生は長距離の選手(5000メートル走)<br>だったそうです。フルマラソンも経験されており、<br>3時間半を切るタイムを記録されたこともあります。'
  },{
  question:'問:N川先生は、登山が好きで富士山にも登ったことがあるそうです。さて、N川先生の「今までに富士山に登った回数」は何回でしょうか？',
  answers: ['2回','5回','8回','12回'],
  correct:'12回',
  studies:'<span>A.12回。</span>最初は奥様に誘われたのがきっかけで、<br>プロポーズも富士山だったそうです。また、家族5人<br>みんなで登ったこともあるといいますから驚きです。'
  },{
  question:'問:N川先生は、フルマラソンも経験され、奥様ともマラソンの大会で出会ったそうです。その大会とは、どこで行われたものだったでしょうか？',
  ...
  question:'問:i永先生は、プロ野球観戦が好きで、休日はよく見ているそうです。プロ野球チームは多くありますが、i永先生の好きなチームはどれでしょう？',
  answers:['広島カープ','読売ジャイアンツ','横浜ベイスターズ','阪神タイガース'],
  correct:'横浜ベイスターズ',
  studies:'<span>A.横浜ベイスターズ。</span>今では多忙なため回数は<br>減っていますが、i永先生が学生の頃には、なんと一年に20試合以上もスタジアムに足を運んだそうです。'
  },{
  question:'問:i永先生はゲームが大好きです。下の選択肢は、i永先生の好きなゲームを上げたものですが、この中で1番プレイ時間が長いものはどれでしょう？',
  answers: ['ゼルダの伝説BotW','NiGHTS(ナイツ)','ドラゴンクエスト3','ロマンシングサ・ガ2'],
  correct:'ドラゴンクエスト3',
  studies:'<span>A.ドラゴンクエスト3。</span>i永先生はRTAも何度か実践<br>しているほどドラクエ3をやりこんでおり、「おそらく<br>プレイ時間は1000時間に達している」とのこと。'
  },{
  question:'問:K泉先生は、コクーンタワーの面白い形に惹かれてHALに来る前は、海外でwebデザイナーをしていました。さて、その場所はどこでしょう？',
  answers:['ロンドン','パリ','フィレンツェ','マドリード'],
  correct:'パリ',
  studies:'<span>A.パリ。</span>あるweb会社の人に提案され、デザイナーと<br>なったそうです。K泉先生は、フランスのwebデザイン<br>コンテストの受賞歴もたくさん持っています。'
  },{
  question:'問:K泉先生は、高校3年間と、卒業後の2年間で、合わせて5年間打ち込んでいたものがあります。さて、それはいったい何でしょう？',
  answers:['野球','サーフィン','バンド','ラグビー'],
  correct:'ラグビー',
  studies:'<span>A.ラグビー。</span>テレビで見たラグビーに感動し、始められた<br>そうです。ちなみに、K泉先生は他の選択肢である野球、<br>バンド、サーフィンも全て経験しています。'
  },{
  question:'問:M上先生は、「あるもの」を見に行った時、それがきっかけでwebの世界に足を踏み入れました。では、そのあるものとは何でしょう？',
  answers:['歌舞伎','人形浄瑠璃','能楽','落語'],
  correct:'歌舞伎',
  studies:'<span>A.歌舞伎。</span>その時見た歌舞伎が美しく、絵を描きました。<br>そして、その描いた絵をたくさんの人に見てもらいたくて、ホームページを作り始めたのが原点だそうです。'
  },{
  question:'問:M上先生は、小学校の頃から演劇に打ち込んでいました。それとは別に、学生時代に好きだったことがあるのですが、それは何でしょう？',
  answers: ['絵を描くこと','スポーツをすること','楽器を弾くこと','写真を撮ること'],
  correct:'絵を描くこと',
  studies:'<span>A.絵を描くこと。</span>M上先生は「ファイブスター物語」「AKIRA」「うしおととら」などの漫画が好きで、同人誌を描き、イベントで販売したこともあるそうです。'
  }
  ];
 const hellodenzin = ['私はXXオネアの管理人を務めております、\n「電人XX」と申します。以後お見知りおきを…', '早速ですが、あなたの先生方に対する知識…\n試させていただきましょうか。', 'それでは、問題です。']
